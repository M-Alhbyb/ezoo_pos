...
- Python 3.11 (backend), TypeScript (frontend) + FastAPI 0.109, SQLAlchemy async 2.0, Pydantic 2.5, PostgreSQL, Next.js 14 (008-supplier-accounting)
...
## Recent Changes
- 008-supplier-accounting: Added Python 3.11 (backend), TypeScript (frontend) + FastAPI 0.109, SQLAlchemy async 2.0, Pydantic 2.5, PostgreSQL, Next.js 14
