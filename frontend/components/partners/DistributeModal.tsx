      ...
      <div className="bg-white rounded-2xl w-full max-w-md overflow-hidden shadow-xl animate-scale-up">
        <div className="px-6 py-4 border-b border-slate-100 flex justify-between items-center bg-slate-50/50">
          <div className="flex items-center gap-2">
            ...
            <h2 className="text-xl font-semibold text-slate-800">Distribute Profits</h2>
          </div>
        ...
        <form onSubmit={handleSubmit} className="p-6">
          ...
          <div className="mb-6 p-4 bg-indigo-50 border border-indigo-100 rounded-xl text-sm text-indigo-800">
            <strong>Note:</strong> Distributions are generated from complete, undistributed projects. You can optionally filter by a date range to only distribute projects completed within that period.
          </div>
