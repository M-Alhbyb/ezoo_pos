export const ARABIC = {
  ...
  pos: {
    ...
    outOfStock: 'لايوجد quantity كافية',
    noStock: 'غير متوفر',
  ...
  suppliers: {
    ...
    subtitle: 'تتبع حسابات الموردين والمدفوعات والمشتريات',
    ...
    addSupplierStart: 'أضف مورداً للبدء في تتبع المشتريات والمدفوعات',
  ...
  customers: {
    title: 'إدارة العملاء',
    subtitle: 'تتبع حسابات العملاء والمدفوعات والمبيعات الآجلة',
    ...
    addCustomerStart: 'أضف عميلاً للبدء في تتبع المبيعات الآجلة',
    ...
    paymentSuccess: 'تم تسجيل الدفعة بنجاح',
    creditSale: 'بيع آجل',
    creditWarning: 'تجاوز الحد الائتماني',
    printStatement: 'طباعة الكشف',
    globalReport: 'تقرير العملاء',
    types: {
      SALE: 'بيع',
      PAYMENT: 'دفعة',
      RETURN: 'مرتجع',
