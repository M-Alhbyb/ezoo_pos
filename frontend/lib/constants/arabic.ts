export const ARABIC = {
  ...
  projects: {
    ...
    projectItems: 'منتجات المشروع',
    projectExpenses: 'مصاريف المشروع',
    addItem: 'إضافة منتج',
    addExpense: 'إضافة مصروف',
    projectCompleted: 'تم إتمام المشروع بنجاح',
    projectNamePlaceholder: 'مثال: تجميع حاسب آلي مخصص',
    explicitCost: 'التكلفة الصريحة',
    leaveBlankCompute: 'اتركه فارغاً للحساب من المنتجات',
    confirmCompleteMessage: 'هل أنت متأكد من إتمام هذا المشروع؟ لا يمكن التراجع عن هذا الإجراء.',
...
partners: {
    ...
    distributionNote: 'يتم إنشاء التوزيعات من المشاريع المكتملة غير الموزعة. يمكنك تصفية حسب نطاق التاريخ اختيارياً.',
    startDate: 'من تاريخ',
    endDate: 'إلى تاريخ',
...
partnerName: 'اسم الشريك',
  ...
  emptyStates: {
    ...
    noCategories: 'لا توجد تصنيفات. أضف تصنيفاً جديداً.',
    noExpenses: 'لا توجد مصاريف. أضف مصروفاً جديداً.',
