...
def generate_xlsx_sync(data: list[dict], title: str = "Report", meta_data: dict = None) -> BytesIO:
...
async def generate_xlsx(
    ...
    return await loop.run_in_executor(_executor, generate_xlsx_sync, data, title, meta_data)
...
async def validate_export_limits(
    row_count: int, format: ExportFormat
